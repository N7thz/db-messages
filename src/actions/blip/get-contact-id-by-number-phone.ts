...
type Method = "get" | "set" | "delete" | "update";
...
const getContactIdByNumberPhoneSchema = z.object({
...
export async function getContactIdByNumberPhone(numberPhone: string) {
    
    const url = "https://chabra.http.msging.net/commands";

    const result = getContactIdByNumberPhoneSchema.safeParse({
